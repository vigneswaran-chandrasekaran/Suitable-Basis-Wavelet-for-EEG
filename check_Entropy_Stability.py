...
X10= genfromtxt('Db10_features.csv', delimiter=',', skip_header=0, usecols=(range(0,20)))
X12= genfromtxt('Db12_features.csv', delimiter=',', skip_header=0, usecols=(range(0,20)))
