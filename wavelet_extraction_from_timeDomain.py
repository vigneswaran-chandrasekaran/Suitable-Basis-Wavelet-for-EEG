...
for k in range(X.shape[0]):
	...
	cA,cD4,cD3,cD2,cD1 = pywt.wavedec(a,db5,level=4)
	d1.append(cD1)
	d2.append(cD2)
	d3.append(cD3)
	d4.append(cD4)
...
numpy.savetxt("db5D1.csv", d1, delimiter=",")
numpy.savetxt("db5D2.csv", d2, delimiter=",")
numpy.savetxt("db5D3.csv", d3, delimiter=",")
numpy.savetxt("db5D4.csv", d4, delimiter=",")
numpy.savetxt("db5A4.csv", a4, delimiter=",")
